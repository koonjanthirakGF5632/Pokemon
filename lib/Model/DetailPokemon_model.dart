...
//
//     final detailpokemonModel = detailpokemonModelFromJson(jsonString);

import 'dart:convert';

DetailpokemonModel detailpokemonModelFromJson(String str) => DetailpokemonModel.fromJson(json.decode(str));

String detailpokemonModelToJson(DetailpokemonModel data) => json.encode(data.toJson());
...
class DetailpokemonModel {
  ...
  factory DetailpokemonModel.fromJson(Map<String, dynamic> json) => DetailpokemonModel(
